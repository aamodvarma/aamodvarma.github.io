...
Using the smact library we also conduct a pauling test and finally validated whether the composition is valid or not. Across our model we got a validity score of up to 75% for the newly generated composition.
